...
Únicamente se estudian las técnicas ***T1072*** y ***T1078***.
...
```{r platforms, echo=FALSE, fig.height=6, fig.width=6, message=FALSE, warning=FALSE}
#Primero extraigo de los edges los nombres de los ficheros de car que debemos revisar a paritr de las tecnicas encontradas en car.
tempCarEdges <- filter(mitre.data$standards$car$carnet$edges, mitre.data$standards$car$carnet$edges$to %in% tecCar)
tempCarEdges <- select(tempCarEdges, from, to)
...
Para cada uno de éstos, se ha representado la relación global (teniendo en cuenta todas las técnicas de estudio) y la relación simplificada (únicamente se tienen en cuenta las dos técnicas más comunes: *T1072* y *T1078*)
...
## Implementacioens a partir de CAR

<br>
Gracias a las tecnicas encontradas en CAR con alguna de las tecnicas encontramos implementaciones par aactuar en base alguna de las tecnicas de los incidentes encontradas.
<br>
...
<br>
En el último punto se ha realizado un resumen sobre las dos técnicas más usadas en los incidentes. A continuación, podremos observar las tacticas, mitigaciones, sofwares y grupos relacionados con cada una de las técnicas, mediante un grafo y una tabla.
<br>

## ***T1072*** {.tabset}

<br>
Empezamos por la técnica más usada en los incidentes. En el siguiente grafo y tabla, se puede apreciar las relaciones que se han encotrado con esta técnica.
<br>
...
<br>
A continuación, podemos ver el grafo y la tabla de las relaciones con la segunda técnica más usada.
<br>
