...
<br>
Para este punto nos hemos decantado por usar el estandard de shield para hacer frente a los ataques. De tal manera que a partir de las tecnicas usadas (TE), buscamos que tecnica defensiva se encuentra (DTE) para poder hacer frente.
<br>

## Todas las relaciones con Shield 

<br>
Una vez tenemos todas las tecnicas defensivas (DTE) relacionadas con las tecnicas que se han usado durante los ataques procedemos a extrarer las relaciones de estas DTEs con las tacticas defensivas (DTA), oportunidades defensivas (DOS),
casos de uso (DUC) y procedimiento defensivos (DPR).
<br>
...
<br>
A continaución podemos apreciar la relación entre las DTEs y sus respectivos casos de uso (DUCs):
<br>
