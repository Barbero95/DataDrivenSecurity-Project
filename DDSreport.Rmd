...
tempCarSelected <- select(tempCar, subtypes, description, implementations)

tempCarSelected %>% kbl() %>% kable_styling()

tempPlatforms <- summarise(tempCar, windows = sum(platform_windows, na.rm = TRUE), linux = sum(platform_linux, na.rm = TRUE), macos = sum(platform_macos, na.rm = TRUE))
