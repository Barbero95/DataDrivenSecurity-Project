...
sort(summary(temp$id))
qplot(x=id, data=temp)
...
tempEdges <- filter(mitre.data$standards$attck$attcknet$edges, startsWith(as.character(mitre.data$standards$attck$attcknet$edges$from), "G"))
...
myg <- visNetwork::visNetwork(nodes = tempNodes, edges = tempEdges, height = "500px", width = "100%", main = "Esquema")
myg
```
